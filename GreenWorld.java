...
public class GreenWorld extends World
{
    ...
    public void act(){
        ...
        if(Greenfoot.getRandomNumber(200) == 0){
            ...
            addObject(new Bubble('u', Color.GREEN), Greenfoot.getRandomNumber(getWidth()), -10);
        }
        if(Greenfoot.getRandomNumber(200) == 0){

            addObject(new Bubble('l', Color.GREEN), -10, Greenfoot.getRandomNumber(getHeight()));
        }
        if(Greenfoot.getRandomNumber(200) == 0){
        ...
        if(rightMost.getX() < getWidth() + 500){
            ...
            if(heightRight == targetHeightRight){
                targetHeightRight = Greenfoot.getRandomNumber(30)+3;
                //targetHeightLeft = 3;
            }
        ...
        if(leftMost.getX() > -500){
            if(heightLeft == targetHeightLeft){
                targetHeightLeft = Greenfoot.getRandomNumber(30)+3;
                //targetHeightRight = 3;
            }
    ...
    public int getRandomHeight(int height, int targetHeight){
        ...
        if(prob >=40 && prob < 85){ //1 change
            gradient = 1;
        }
        else if(prob >= 85){ //2 change
            gradient = 2;
        }
